-- Contract: profiles table + RLS + auto-provisioning trigger
-- This file is the source of truth for migration 0001_profiles.sql.
-- Any change here must be mirrored in supabase/migrations/0001_profiles.sql.
